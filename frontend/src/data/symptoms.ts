...
export const allSymptoms: Symptom[] = [
  ...
  { id: '3', name: 'Facial Pain', categories: ['Pain'], bodyParts: ['Face'] },
  {
    id: '4',
    name: 'Blurred Vision',
    categories: ['Vision', 'Neurological'],
    bodyParts: ['Eyes'],
  },
  {
    id: '5',
    name: 'Ringing in Ears',
    categories: ['Hearing', 'Neurological'],
    bodyParts: ['Ears'],
  },
  ...
  // Chest and Respiratory
  {
    id: '6',
    name: 'Chest Pain',
    categories: ['Pain', 'Cardiovascular', 'Respiratory'],
    bodyParts: ['Chest'],
  },
  {
    id: '7',
  ...
  },
  {
    ...
    bodyParts: ['Abdomen', 'Stomach'],
  },
  {
    id: '12',
    name: 'Vomiting',
    categories: ['Digestive', 'Infection'],
    bodyParts: ['Abdomen', 'Stomach'],
  },
  {
    id: '13',
  ...
  // General/Systemic
  {
    id: '14',
    name: 'Fever',
    categories: ['Infection', 'Inflammatory'],
    bodyParts: [],
  },
  {
    id: '15',
  ...
  // Extremities
  {
    id: '18',
    name: 'Joint Pain',
    categories: ['Pain', 'Musculoskeletal', 'Inflammatory'],
    bodyParts: ['Arms', 'Legs', 'Hands', 'Feet'],
  },
  {
    id: '19',
    name: 'Swelling',
    categories: ['Inflammatory', 'Cardiovascular'],
    bodyParts: ['Arms', 'Legs', 'Hands', 'Feet', 'Face'],
  },
  {
    id: '20',
    name: 'Numbness',
  ...
  // Skin
  {
    id: '21',
    name: 'Rash',
    categories: ['Skin', 'Allergic', 'Inflammatory', 'Infection'],
    bodyParts: [],
  },
  {
    id: '22',
    name: 'Itching',
    categories: ['Skin', 'Allergic'],
    bodyParts: [],
  },
  //General/Cardiovascular
  {
    ...
    categories: ['General', 'Cardiovascular'],
    bodyParts: [],
  },
  {
    id: '24',
...
export const bodyRegions: BodyRegion[] = [
  ...
  },
  {
    id: 'extremities',
    name: 'Arms & Legs',
    symptoms: ['Joint Pain', 'Swelling', 'Numbness', 'Muscle Aches'],
  },
